            ...
            {status === 'done' && (
                <div className="bg-white dark:bg-dark-surface p-12 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 max-w-2xl mx-auto">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <button onClick={() => window.location.href = '/admin/products'} className="px-6 py-3 bg-primary text-white rounded-xl hover:bg-secondary font-bold transition-colors shadow-sm">
                            View Products
                        </button>
                    </div>
                </div>
