        ...
        <div className="max-w-7xl mx-auto pb-20 px-4 space-y-8 animate-in fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-gray-200 dark:border-gray-800 pb-6 shrink-0">
                ...
                <div className="flex gap-3">
                    <Link href="/admin/products" className="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-bold rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition text-sm flex items-center gap-2">
                        <Package size={16} /> Add Product
                    </Link>
                    <Link href="/admin/inquiries" className="px-4 py-2 bg-primary text-white font-bold rounded-lg shadow hover:bg-primary/90 transition text-sm flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-dark-surface border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden flex flex-col">
                    <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-dark-bg">
                        ...
                        <Link href="/admin/rfq" className="text-xs font-bold text-primary hover:underline flex items-center gap-1">View Pipeline <ArrowRight size={12} /></Link>
                    </div>
                ...
                <div className="bg-white dark:bg-dark-surface border border-gray-200 dark:border-gray-800 rounded-2xl shadow-sm overflow-hidden flex flex-col">
                    <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-dark-bg">
                        ...
                        <Link href="/admin/inquiries" className="text-xs font-bold text-primary hover:underline flex items-center gap-1">View All <ArrowRight size={12} /></Link>
                    </div>
                    <div className="p-0 flex-1 overflow-x-auto">
                        <table className="w-full text-left font-sans text-sm">
                            <thead className="bg-white dark:bg-dark-surface text-xs tracking-wider uppercase text-gray-500 font-bold border-b border-gray-100 dark:border-gray-800">
