...
import { Save, Loader2, Globe, Facebook, Linkedin, Instagram, Twitter, Youtube, MapPin, Building, Phone, Mail, Clock, DollarSign } from 'lucide-react';
                ...
                <div className="p-6 space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input name="company_name" type="text" value={formData.company_name || ''} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:ring-2 focus:ring-primary/50 transition-shadow" />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold mb-2">Tagline</label>
                            <input name="company_tagline" type="text" value={formData.company_tagline || ''} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:ring-2 focus:ring-primary/50 transition-shadow" />
                        </div>
                        <div>
                            <label className="block text-sm font-semibold mb-2">Founded Year</label>
                            <input name="founded_year" type="text" value={formData.founded_year || ''} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:ring-2 focus:ring-primary/50 transition-shadow" />
                        </div>
                        <div>
                            ...
                            <input name="website_url" type="url" value={formData.website_url || ''} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:ring-2 focus:ring-primary/50 transition-shadow" />
                        </div>
                        <div>
                            ...
                            <input name="company_phone" type="text" value={formData.company_phone || ''} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 outline-none focus:ring-2 focus:ring-primary/50 transition-shadow" />
                        </div>
                        <div>
