                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" value={settings['smtp_from_name'] || ''} onChange={e => updateSetting('smtp_from_name', e.target.value)} className="w-full border rounded p-2.5 text-sm bg-gray-50 dark:bg-dark-bg focus:ring-primary outline-none" placeholder="APPAREL EMPORIUM Notification" />
                                    </div>
                                    <div>
